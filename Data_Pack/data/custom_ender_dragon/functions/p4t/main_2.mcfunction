...
execute at @e[tag=end_crystal_marker] run summon minecraft:marker ~ 109 ~ {Tags:["glass_pillar"]}
execute at @e[tag=end_crystal_marker] run summon minecraft:marker ~ 114 ~ {Tags:["glass_destroyer"]}