...
execute if score @e[type=marker,tag=emaster,limit=1] dragon_rng matches 1 if score @e[type=marker,tag=emaster,limit=1] dragon_phase matches 12..14 run execute at @e[type=marker,tag=phase_2t,sort=random,limit=1] unless entity @e[type=minecraft:end_crystal,distance=..1] run summon minecraft:end_crystal ~ ~ ~ {ShowBottom:false,Glowing:true,beam_target:[I;0,73,0]}
...
execute in minecraft:the_end positioned 0 70 0 if entity @a[distance=..100] as @e[type=ender_dragon,scores={dragon_flight_timer=20..},limit=1] unless data entity @s {Health:1.0f} run data merge entity @s {DragonPhase:2}
execute in minecraft:the_end positioned 0 70 0 if entity @a[distance=..100] as @e[type=ender_dragon,scores={dragon_flight_timer=20..},limit=1] unless data entity @s {Health:1.0f} run data merge entity @s {DragonPhase:2}
