...
execute in minecraft:the_end positioned 0 200 0 run summon minecraft:armor_stand ~ 200 ~ {OnGround:0b,Tags:["Meteor","spread"],Invisible:1b,ArmorItems:[{},{},{},{id:amethyst_block,Count:1b}],Small:1b}
execute in minecraft:the_end positioned 0 200 0 run summon minecraft:armor_stand ~ 200 ~ {OnGround:0b,Tags:["Meteor","spread"],Invisible:1b,ArmorItems:[{},{},{},{id:amethyst_block,Count:1b}],Small:1b}
execute in minecraft:the_end positioned 0 200 0 run summon minecraft:armor_stand ~ 200 ~ {OnGround:0b,Tags:["Meteor","spread"],Invisible:1b,ArmorItems:[{},{},{},{id:amethyst_block,Count:1b}],Small:1b}
execute in minecraft:the_end positioned 0 200 0 run summon minecraft:armor_stand ~ 200 ~ {OnGround:0b,Tags:["Meteor","spread"],Invisible:1b,ArmorItems:[{},{},{},{id:amethyst_block,Count:1b}],Small:1b}
