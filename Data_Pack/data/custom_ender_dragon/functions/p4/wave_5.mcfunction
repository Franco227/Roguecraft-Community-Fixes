...
summon minecraft:wither_skeleton ~ ~ ~ {Tags:["phase_4_mob"],DeathLootTable:"minecraft:empty",HandItems:[{id:"minecraft:stone_sword"}],HandDropChances:[0.0f,0.0f],PersistenceRequired:true}
summon minecraft:wither_skeleton ~ ~ ~ {Tags:["phase_4_mob"],DeathLootTable:"minecraft:empty",HandItems:[{id:"minecraft:stone_sword"}],HandDropChances:[0.0f,0.0f],PersistenceRequired:true}
summon minecraft:wither_skeleton ~ ~ ~ {Tags:["phase_4_mob"],DeathLootTable:"minecraft:empty",HandItems:[{id:"minecraft:stone_sword"}],HandDropChances:[0.0f,0.0f],PersistenceRequired:true}
summon minecraft:wither_skeleton ~ ~ ~ {Tags:["phase_4_mob"],DeathLootTable:"minecraft:empty",HandItems:[{id:"minecraft:stone_sword"}],HandDropChances:[0.0f,0.0f],PersistenceRequired:true}
summon minecraft:wither_skeleton ~ ~ ~ {Tags:["phase_4_mob"],DeathLootTable:"minecraft:empty",HandItems:[{id:"minecraft:stone_sword"}],HandDropChances:[0.0f,0.0f],PersistenceRequired:true}
