...
execute if score @e[type=minecraft:marker,tag=emaster,limit=1] dragon_phase matches 2 run scoreboard players add @e[type=minecraft:marker,tag=emaster,limit=1] dragon_p1t_health 5
execute if score @e[type=minecraft:marker,tag=emaster,limit=1] dragon_phase matches 2 run execute store result bossbar minecraft:custom_dragon value run scoreboard players get @e[type=minecraft:marker,tag=emaster,limit=1] dragon_p1t_health
execute if score @e[type=minecraft:marker,tag=emaster,limit=1] dragon_phase matches 2 run execute at @e[type=minecraft:marker,tag=end_crystal_marker] run particle minecraft:dust{color:[0.73,0.0,1.0],scale:4.0} ~ ~ ~ 2 30 2 1 1 force
...
execute unless entity @e[tag=phase_4_mob] if entity @e[type=minecraft:marker,tag=emaster,scores={dragon_phase=7}] at @e[type=minecraft:marker,tag=summon_portal] run function custom_ender_dragon:p4/wave_2
execute unless entity @e[tag=phase_4_mob] if entity @e[type=minecraft:marker,tag=emaster,scores={dragon_phase=8}] at @e[type=minecraft:marker,tag=summon_portal] run function custom_ender_dragon:p4/wave_3
execute unless entity @e[tag=phase_4_mob] if entity @e[type=minecraft:marker,tag=emaster,scores={dragon_phase=9}] at @e[type=minecraft:marker,tag=summon_portal] run function custom_ender_dragon:p4/wave_4
execute unless entity @e[tag=phase_4_mob] if entity @e[type=minecraft:marker,tag=emaster,scores={dragon_phase=10}] at @e[type=minecraft:marker,tag=summon_portal] run function custom_ender_dragon:p4/wave_5
execute unless entity @e[tag=phase_4_mob] if entity @e[type=minecraft:marker,tag=emaster,scores={dragon_phase=11}] at @e[type=minecraft:marker,tag=summon_portal] run function custom_ender_dragon:p4t/main_1
...
#dragon_phase 14
execute if entity @e[type=minecraft:marker,tag=emaster,scores={dragon_phase=14}] if score @e[type=minecraft:marker,tag=emaster,limit=1] dragon_health matches ..0 run function custom_ender_dragon:p5/end
...
#missile
execute as @e[type=minecraft:area_effect_cloud,tag=auto_aim] run data merge entity @s {Motion:[0.0,0.0,0.0]}
execute as @e[type=minecraft:area_effect_cloud,tag=auto_aim] at @s facing entity @p[gamemode=!spectator] feet run tp ^ ^ ^0.2
execute at @e[type=minecraft:area_effect_cloud,tag=auto_aim] run particle minecraft:portal ~ ~ ~ 0.5 0.5 0.5 0 10 normal
execute at @e[type=minecraft:area_effect_cloud,tag=auto_aim] run particle minecraft:portal ~ ~ ~ 0.5 0.5 0.5 0 5 force
execute at @e[type=minecraft:area_effect_cloud,tag=auto_aim] run particle minecraft:dust{color:[0.73,0.0,1.0],scale:3.0} ~ ~ ~ 0.5 0.5 0.5 0.01 7 force
...
execute at @e[type=minecraft:area_effect_cloud,tag=auto_aim] run particle minecraft:dust{color:[0.73,0.0,1.0],scale:2.0} ~ ~ ~ 5 5 5 0.02 3 normal
