...
summon minecraft:skeleton ~ ~ ~ {Tags:["phase_4_mob"],DeathLootTable:"minecraft:empty",HandItems:[{Count:1,id:"minecraft:bow"}],HandDropChances:[0.0f,0.0f],PersistenceRequired:true}
summon minecraft:skeleton ~ ~ ~ {Tags:["phase_4_mob"],DeathLootTable:"minecraft:empty",HandItems:[{Count:1,id:"minecraft:bow"}],HandDropChances:[0.0f,0.0f],PersistenceRequired:true}
summon minecraft:skeleton ~ ~ ~ {Tags:["phase_4_mob"],DeathLootTable:"minecraft:empty",HandItems:[{Count:1,id:"minecraft:bow"}],HandDropChances:[0.0f,0.0f],PersistenceRequired:true}
summon minecraft:skeleton ~ ~ ~ {Tags:["phase_4_mob"],DeathLootTable:"minecraft:empty",HandItems:[{Count:1,id:"minecraft:bow"}],HandDropChances:[0.0f,0.0f],PersistenceRequired:true}
summon minecraft:skeleton ~ ~ ~ {Tags:["phase_4_mob"],DeathLootTable:"minecraft:empty",HandItems:[{Count:1,id:"minecraft:bow"}],HandDropChances:[0.0f,0.0f],PersistenceRequired:true}
