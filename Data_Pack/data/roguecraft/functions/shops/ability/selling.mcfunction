...
$execute if score @s $(upgrade) matches 0 if score @s ability_1 matches $(id) run item replace entity @s container.0 with warped_fungus_on_a_stick{CustomModelData:2,display:{Name:'[{"translate":"roguecraft.item.ability","color":"light_purple","with":[{"translate":"roguecraft.generic.ability"},"1"],"italic":false}]'}}
...
$execute if score @s $(upgrade) matches 0 if score @s ability_2 matches $(id) run item replace entity @s container.1 with warped_fungus_on_a_stick{CustomModelData:3,display:{Name:'[{"translate":"roguecraft.item.ability","color":"light_purple","with":[{"translate":"roguecraft.generic.ability"},"2"],"italic":false}]'}}
...
$execute if score @s $(upgrade) matches 0 if score @s ability_3 matches $(id) run item replace entity @s container.2 with warped_fungus_on_a_stick{CustomModelData:4,display:{Name:'[{"translate":"roguecraft.item.ability","color":"light_purple","with":[{"translate":"roguecraft.generic.ability"},"3"],"italic":false}]'}}
