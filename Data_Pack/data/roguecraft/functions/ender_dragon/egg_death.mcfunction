...
execute if score @e[tag=master,type=minecraft:marker,limit=1] difficulty_level matches ..4 run advancement grant @a[tag=!garden,tag=!hub,advancements={roguecraft:roguecraft/speedrun=false}] only roguecraft:roguecraft/speedrun
execute if score @e[tag=master,type=minecraft:marker,limit=1] difficulty_level matches ..2 run advancement grant @a[tag=!garden,tag=!hub,advancements={roguecraft:roguecraft/world_record=false}] only roguecraft:roguecraft/world_record
