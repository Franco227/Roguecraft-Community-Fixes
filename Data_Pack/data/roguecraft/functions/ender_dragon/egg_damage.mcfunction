...
scoreboard players add @e[type=minecraft:block_display,tag=egg_block] egg_damage 1
...
execute as @e[type=minecraft:block_display,tag=egg_block] at @s run tp @s ~ ~ ~ ~5 ~
execute if entity @e[type=minecraft:block_display,scores={egg_damage=8},tag=egg_block] run function roguecraft:ender_dragon/egg_death