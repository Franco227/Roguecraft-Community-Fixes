...
execute as @e[tag=infinite_garden_loot,tag=!tagged,type=minecraft:marker,limit=1] run function roguecraft:infinite_garden/spread_marker
...
execute as @e[tag=infinite_garden_loot,nbt={data:{}}] run scoreboard players remove @e[type=minecraft:marker,tag=master] beam_amount 1
