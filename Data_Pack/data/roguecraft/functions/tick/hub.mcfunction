...
execute as @e[type=minecraft:item_display,tag=obelisk] at @s if data entity @e[distance=..5,type=marker,sort=nearest,limit=1] {data:{status:0b}} run particle minecraft:dust{color:[0.5,0.0,0.0],scale:1.0} ~ ~ ~ 0.75 1 0.75 0 1
execute as @e[type=minecraft:item_display,tag=obelisk] at @s if data entity @e[distance=..5,type=marker,sort=nearest,limit=1] {data:{status:1b}} run particle minecraft:dust{color:[0.0,0.894,0.961],scale:1.0} ~ ~ ~ 0.75 1 0.75 0 1
execute as @e[type=minecraft:item_display,tag=obelisk] at @s if data entity @e[distance=..5,type=marker,sort=nearest,limit=1] {data:{status:2b}} run particle minecraft:dust{color:[1.0,1.0,1.0],scale:1.0} ~ ~ ~ 0.75 1 0.75 0 1
execute as @e[type=minecraft:item_display,tag=obelisk] at @s if data entity @e[distance=..5,type=marker,sort=nearest,limit=1] {Tags:["center"]} run particle minecraft:dust{color:[0.5,0.0,0.0],scale:0.5} ~ ~ ~ 1 1.5 1 0 1
...
#shop glow
execute as @e[tag=class_shop,nbt={data:{id:0}}] at @s run particle dust{color:[0.0,0.984,1.0],scale:1.0} ~ ~-1 ~ 0.4 0.025 0.4 0 1 normal @a[distance=..8,scores={class=0}]
execute as @e[tag=class_shop,nbt={data:{id:1}}] at @s run particle dust{color:[0.0,0.984,1.0],scale:1.0} ~ ~-1 ~ 0.4 0.025 0.4 0 1 normal @a[distance=..8,scores={class=1}]
execute as @e[tag=class_shop,nbt={data:{id:2}}] at @s run particle dust{color:[0.0,0.984,1.0],scale:1.0} ~ ~-1 ~ 0.4 0.025 0.4 0 1 normal @a[distance=..8,scores={class=2}]
execute as @e[tag=class_shop,nbt={data:{id:3}}] at @s run particle dust{color:[0.0,0.984,1.0],scale:1.0} ~ ~-1 ~ 0.4 0.025 0.4 0 1 normal @a[distance=..8,scores={class=3}]
execute as @e[tag=class_shop,nbt={data:{id:4}}] at @s run particle dust{color:[0.0,0.984,1.0],scale:1.0} ~ ~-1 ~ 0.4 0.025 0.4 0 1 normal @a[distance=..8,scores={class=4}]
