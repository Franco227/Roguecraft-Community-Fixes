...
#obelisks
execute as @e[type=minecraft:interaction,tag=obelisk] if data entity @s attack at @s run function roguecraft:infinite_garden/hub/obelisk_tell with entity @e[type=minecraft:marker,sort=nearest,limit=1] data
execute as @e[type=minecraft:interaction,tag=obelisk] if data entity @s interaction at @s run function roguecraft:infinite_garden/hub/obelisk_tell with entity @e[type=minecraft:marker,sort=nearest,limit=1] data
...
execute as @e[type=minecraft:item_display,tag=obelisk] at @s if data entity @e[distance=..5,type=minecraft:marker,sort=nearest,limit=1] {data:{status:0b}} run particle minecraft:dust{color:[0.5,0.0,0.0],scale:1.0} ~ ~ ~ 0.75 1 0.75 0 1
execute as @e[type=minecraft:item_display,tag=obelisk] at @s if data entity @e[distance=..5,type=minecraft:marker,sort=nearest,limit=1] {data:{status:1b}} run particle minecraft:dust{color:[0.0,0.894,0.961],scale:1.0} ~ ~ ~ 0.75 1 0.75 0 1
execute as @e[type=minecraft:item_display,tag=obelisk] at @s if data entity @e[distance=..5,type=minecraft:marker,sort=nearest,limit=1] {data:{status:2b}} run particle minecraft:dust{color:[1.0,1.0,1.0],scale:1.0} ~ ~ ~ 0.75 1 0.75 0 1
execute as @e[type=minecraft:item_display,tag=obelisk] at @s if data entity @e[distance=..5,type=minecraft:marker,sort=nearest,limit=1] {Tags:["center"]} run particle minecraft:dust{color:[0.5,0.0,0.0],scale:0.5} ~ ~ ~ 1 1.5 1 0 1
execute as @e[type=minecraft:item_display,tag=obelisk] at @s if data entity @e[distance=..5,type=minecraft:marker,sort=nearest,limit=1] {Tags:["center"]} run particle minecraft:warped_spore ~ ~-2 ~ 1 1 1 0 10

execute unless data storage roguecraft:master {bosses_checked:1b} in roguecraft:infinite_garden positioned 0.5 58 19.5 as @e[distance=..0.5,type=minecraft:marker,tag=seal_room] at @s if entity @a[x=-1.7,dx=5,y=58,dy=7,z=19,dz=2] run function roguecraft:infinite_garden/hub/seal/check_bosses
...
#shop glow
execute as @e[tag=class_shop,nbt={data:{id:0}}] at @s run particle minecraft:dust{color:[0.0,0.984,1.0],scale:1.0} ~ ~-1 ~ 0.4 0.025 0.4 0 1 normal @a[distance=..8,scores={class=0}]
execute as @e[tag=class_shop,nbt={data:{id:1}}] at @s run particle minecraft:dust{color:[0.0,0.984,1.0],scale:1.0} ~ ~-1 ~ 0.4 0.025 0.4 0 1 normal @a[distance=..8,scores={class=1}]
execute as @e[tag=class_shop,nbt={data:{id:2}}] at @s run particle minecraft:dust{color:[0.0,0.984,1.0],scale:1.0} ~ ~-1 ~ 0.4 0.025 0.4 0 1 normal @a[distance=..8,scores={class=2}]
execute as @e[tag=class_shop,nbt={data:{id:3}}] at @s run particle minecraft:dust{color:[0.0,0.984,1.0],scale:1.0} ~ ~-1 ~ 0.4 0.025 0.4 0 1 normal @a[distance=..8,scores={class=3}]
execute as @e[tag=class_shop,nbt={data:{id:4}}] at @s run particle minecraft:dust{color:[0.0,0.984,1.0],scale:1.0} ~ ~-1 ~ 0.4 0.025 0.4 0 1 normal @a[distance=..8,scores={class=4}]
...
#hub stuff
execute in roguecraft:infinite_garden positioned 0 63 0 run kill @e[distance=..82,type=minecraft:item,nbt={Item:{id:"minecraft:totem_of_undying"}}]
