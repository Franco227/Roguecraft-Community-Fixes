...
execute as @e[tag=flame,tag=main,type=minecraft:slime,tag=boss_hitbox] at @s unless entity @e[type=minecraft:area_effect_cloud,distance=..3.5] run data merge entity @s {HasVisualFire:0b}
