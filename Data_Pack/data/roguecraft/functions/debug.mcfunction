...
#scoreboard players set @e[type=marker,tag=master] ability_cost_0_3 70
##heal
#scoreboard players set @e[type=marker,tag=master] ability_cost_1_1 50
#scoreboard players set @e[type=marker,tag=master] ability_cost_1_2 40
...
##dirt walker
#scoreboard players set @e[type=marker,tag=master] ability_cost_11_1 70
#scoreboard players set @e[type=marker,tag=master] ability_cost_11_2 65
#scoreboard players set @e[type=marker,tag=master] ability_cost_11_3 60
##class abilities
...
#tellraw @a ["","region_x: ",{"score":{"name":"@e[type=marker,tag=master,limit=1]","objective":"region_x"}}," | region_z: ",{"score":{"name":"@e[type=marker,tag=master,limit=1]","objective":"region_z"}}," | region_counter: ",{"score":{"name":"@e[type=marker,tag=master,limit=1]","objective":"region_counter"}}," | region_counter_max: ",{"score":{"name":"@e[type=marker,tag=master,limit=1]","objective":"region_counter_max"}}," | region_dir: ",{"score":{"name":"@e[type=marker,tag=master,limit=1]","objective":"region_dir"}}]
