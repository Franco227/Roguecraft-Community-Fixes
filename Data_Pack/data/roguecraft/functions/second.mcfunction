...
#ender dragon
execute at @e[type=minecraft:area_effect_cloud,tag=auto_aim] run execute as @a[distance=..3] run damage @s 4 minecraft:magic by @e[type=minecraft:ender_dragon,limit=1]
