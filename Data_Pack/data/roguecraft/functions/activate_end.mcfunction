...
execute in minecraft:the_end positioned 0 0 0 run kill @e[type=minecraft:marker,distance=..2000]
execute in minecraft:the_end positioned 0 0 0 run kill @e[type=minecraft:arrow,distance=..2000]
execute in minecraft:the_end positioned 0 0 0 run kill @e[type=minecraft:enderman,distance=..2000]
execute in minecraft:the_end positioned 0 0 0 run kill @e[type=minecraft:armor_stand,distance=..2000]
execute in minecraft:the_end positioned 0 0 0 run kill @e[type=minecraft:item,distance=..2000]
execute in minecraft:the_end positioned 0 0 0 run kill @e[type=minecraft:shulker,distance=..2000]
execute in minecraft:the_end positioned 0 0 0 run kill @e[type=minecraft:end_crystal,distance=..2000]
execute in minecraft:the_end positioned 0 0 0 run kill @e[type=minecraft:area_effect_cloud,distance=..2000]
