scoreboard players set @s liquid_timer 150
tag @a[scores={liquid_timer=1..}] add apply_liquid_bar
execute at @s as @e[tag=id,type=minecraft:marker] run function roguecraft:ability/liquid_walker/apply_bossbar with entity @s data
