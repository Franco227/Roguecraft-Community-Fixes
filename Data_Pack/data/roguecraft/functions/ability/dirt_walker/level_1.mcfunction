scoreboard players set @s dirt_timer 80
tag @a[scores={dirt_timer=1..}] add apply_dirt_bar
execute at @s as @e[tag=id,type=minecraft:marker] run function roguecraft:ability/dirt_walker/apply_bossbar with entity @s data
