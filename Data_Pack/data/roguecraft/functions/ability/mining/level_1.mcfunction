...
#execute if dimension minecraft:overworld if score @s y matches -6300.. run fill ~1 ~2 ~1 ~-1 ~ ~-1 air destroy
#execute if dimension minecraft:overworld if score @s y matches ..-6300 run fill ~1 ~2 ~1 ~-1 -64 ~-1 air destroy

#execute if dimension roguecraft:infinite_garden if score @s y matches -6300.. run fill ~1 ~2 ~1 ~-1 ~ ~-1 air destroy
#execute if dimension roguecraft:infinite_garden if score @s y matches ..-6300 run fill ~1 ~2 ~1 ~-1 -64 ~-1 air destroy

#execute unless dimension minecraft:overworld unless dimension roguecraft:infinite_garden if score @s y matches 100.. run fill ~1 ~2 ~1 ~-1 ~ ~-1 air destroy
#execute unless dimension minecraft:overworld unless dimension roguecraft:infinite_garden if score @s y matches ..100 run fill ~1 ~2 ~1 ~-1 0 ~-1 air destroy
