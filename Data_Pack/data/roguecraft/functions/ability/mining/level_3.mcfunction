...
#execute if dimension minecraft:overworld if score @s y matches -6100.. run fill ~3 ~4 ~3 ~-3 ~-2 ~-3 minecraft:air destroy
#execute if dimension minecraft:overworld if score @s y matches ..-6100 run fill ~3 ~4 ~3 ~-3 -64 ~-3 minecraft:air destroy

#execute if dimension roguecraft:infinite_garden if score @s y matches -6100.. run fill ~3 ~4 ~3 ~-3 ~-2 ~-3 minecraft:air destroy
#execute if dimension roguecraft:infinite_garden if score @s y matches ..-6100 run fill ~3 ~4 ~3 ~-3 -64 ~-3 minecraft:air destroy

#execute unless dimension minecraft:overworld unless dimension roguecraft:infinite_garden if score @s y matches 300.. run fill ~3 ~4 ~3 ~-3 ~-2 ~-3 minecraft:air destroy
#execute unless dimension minecraft:overworld unless dimension roguecraft:infinite_garden if score @s y matches ..300 run fill ~3 ~4 ~3 ~-3 0 ~-3 minecraft:air destroy
