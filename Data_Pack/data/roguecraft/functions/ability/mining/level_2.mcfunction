...
#execute if dimension minecraft:overworld if score @s y matches -6200.. run fill ~2 ~3 ~2 ~-2 ~-1 ~-2 minecraft:air destroy
#execute if dimension minecraft:overworld if score @s y matches ..-6200 run fill ~2 ~3 ~2 ~-2 -64 ~-2 minecraft:air destroy

#execute if dimension roguecraft:infinite_garden if score @s y matches -6200.. run fill ~2 ~3 ~2 ~-2 ~-1 ~-2 minecraft:air destroy
#execute if dimension roguecraft:infinite_garden if score @s y matches ..-6200 run fill ~2 ~3 ~2 ~-2 -64 ~-2 minecraft:air destroy

#execute unless dimension minecraft:overworld unless dimension roguecraft:infinite_garden if score @s y matches 200.. run fill ~2 ~3 ~2 ~-2 ~-1 ~-2 minecraft:air destroy
#execute unless dimension minecraft:overworld unless dimension roguecraft:infinite_garden if score @s y matches ..200 run fill ~2 ~3 ~2 ~-2 0 ~-2 minecraft:air destroy
