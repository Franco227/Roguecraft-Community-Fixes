...
particle flame ~ ~0.1 ~ 0.2 0.2 0.2 0.025 2
execute if entity @s[tag=a20] unless entity @s[tag=a60] run particle soul_fire_flame ~ ~0.3 ~ 0.3 0.5 0.3 0.025 1
execute if entity @s[tag=a40] unless entity @s[tag=a60] run particle flame ~ ~0.8 ~ 0.4 0.8 0.4 0.025 1
