execute rotated ~ ~ run summon marker ^ ^ ^12 {Tags:["wildfire_particle","1"]}
execute rotated ~90 ~ run summon marker ^ ^ ^12 {Tags:["wildfire_particle","2"]}
execute rotated ~180 ~ run summon marker ^ ^ ^12 {Tags:["wildfire_particle","3"]}
execute rotated ~270 ~ run summon marker ^ ^ ^12 {Tags:["wildfire_particle","4"]}
execute rotated ~45 ~ run summon marker ^ ^ ^12 {Tags:["wildfire_particle","5"]}
execute rotated ~135 ~ run summon marker ^ ^ ^12 {Tags:["wildfire_particle","6"]}
execute rotated ~225 ~ run summon marker ^ ^ ^12 {Tags:["wildfire_particle","7"]}
execute rotated ~315 ~ run summon marker ^ ^ ^12 {Tags:["wildfire_particle","8"]}
