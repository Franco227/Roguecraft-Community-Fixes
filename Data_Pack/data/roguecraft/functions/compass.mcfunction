...
execute as @s[scores={enter_nether=1}] if data storage roguecraft:master {stronghold:0b} run function roguecraft:compass_nether_fortress with entity @e[type=minecraft:armor_stand,tag=structure_stand,limit=1] HandItems[0].tag.Decorations[0]
