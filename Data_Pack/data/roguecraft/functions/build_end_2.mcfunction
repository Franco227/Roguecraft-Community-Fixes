...
execute unless data storage roguecraft:master end_generation_list[0] in minecraft:the_end run fill -100 118 -100 100 255 100 air
execute unless data storage roguecraft:master end_generation_list[0] in minecraft:the_end run fill 63 0 63 -63 0 -63 air