...
execute at @e[type=minecraft:marker,tag=wildfire,scores={boss_health=..0}] run playsound entity.generic.explode master @a ~ ~ ~
execute at @e[type=minecraft:marker,tag=wildfire,scores={boss_health=..0}] run particle flame ~ ~2.5 ~ 0.25 0.5 0.25 2 800
