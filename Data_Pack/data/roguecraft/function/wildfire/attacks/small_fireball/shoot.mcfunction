...
data modify entity @e[type=minecraft:small_fireball,tag=current_fireball,limit=1] Motion[0] set from entity @e[type=minecraft:marker,tag=wildfire_fireball,limit=1] data.X
data modify entity @e[type=minecraft:small_fireball,tag=current_fireball,limit=1] Motion[1] set from entity @e[type=minecraft:marker,tag=wildfire_fireball,limit=1] data.Y
data modify entity @e[type=minecraft:small_fireball,tag=current_fireball,limit=1] Motion[2] set from entity @e[type=minecraft:marker,tag=wildfire_fireball,limit=1] data.Z
