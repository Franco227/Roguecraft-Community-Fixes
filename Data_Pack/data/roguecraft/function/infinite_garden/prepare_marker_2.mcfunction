...
execute in roguecraft:infinite_garden positioned 0 0 0 as @e[type=minecraft:marker,distance=..1] run scoreboard players remove @e[type=minecraft:marker,tag=master] beam_amount 1
