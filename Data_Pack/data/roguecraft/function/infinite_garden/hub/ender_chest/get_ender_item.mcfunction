...
execute unless score @e[type=minecraft:marker,tag=master,limit=1] enderchest_index matches -1 run function roguecraft:infinite_garden/hub/ender_chest/get_ender_item with storage roguecraft:master enderchest