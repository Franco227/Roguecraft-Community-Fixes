...
execute at @s on attacker run damage @s 30 minecraft:generic by @p
...
scoreboard players operation @s mana += @e[type=minecraft:marker,tag=master,limit=1] ability_cost_5_3
