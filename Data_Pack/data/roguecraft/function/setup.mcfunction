...
scoreboard objectives add soul_charge dummy
scoreboard objectives add max_soul_charge dummy
scoreboard objectives add soul_charge_calc_temp dummy
...
scoreboard objectives add class_reaper dummy
...
scoreboard objectives add level_min dummy
...
scoreboard objectives add wildfire_defeated dummy

scoreboard objectives add enderchest_index dummy
...
scoreboard objectives add boss_id dummy
scoreboard objectives add boss_health dummy
scoreboard objectives add boss_health_per_player dummy
scoreboard objectives add damage_reduction dummy
scoreboard objectives add shield_0_health dummy
scoreboard objectives add shield_1_health dummy
scoreboard objectives add shield_2_health dummy
scoreboard objectives add shield_3_health dummy
scoreboard objectives add hitbox_health dummy
scoreboard objectives add health_loss dummy
scoreboard objectives add lowest_health dummy
scoreboard objectives add damage_percentage dummy
scoreboard objectives add attack_cooldown dummy
scoreboard objectives add last_attack dummy
scoreboard objectives add half_health dummy

scoreboard objectives add hover_accleration dummy
scoreboard objectives add hover_speed dummy
scoreboard objectives add hover_multiplier dummy
scoreboard objectives add hover_upper_limit dummy
scoreboard objectives add hover_lower_limit dummy
scoreboard objectives add hover_phase dummy
scoreboard objectives add hover_accleration_inc dummy

scoreboard objectives add marker_distance dummy
...
scoreboard objectives add hub_tp trigger

scoreboard objectives add adrenaline_advancement_timer dummy
scoreboard objectives add shops_completed dummy

scoreboard objectives add infinite_garden_mob_cap dummy
scoreboard objectives add infinite_garden_mob_count_1 dummy
scoreboard objectives add infinite_garden_mob_count_2 dummy
scoreboard objectives add infinite_garden_marker_type dummy
scoreboard objectives add infinite_garden_skillpoint_phase dummy

scoreboard objectives add corpus dummy
scoreboard objectives add sol dummy
scoreboard objectives add custos dummy
scoreboard objectives add aqua dummy
scoreboard objectives add tyrannus dummy
scoreboard objectives add anima dummy
scoreboard objectives add fatum dummy
...
scoreboard objectives add beam_amount dummy
...
#mine
scoreboard players set @e[type=minecraft:marker,tag=master] ability_cost_2_1 15
scoreboard players set @e[type=minecraft:marker,tag=master] ability_cost_2_2 22
...
data merge storage roguecraft:master {gigadrill:{level_1:8,level_2:16,level_3:20}}

# Initialize calculation of player ids
scoreboard objectives add playerid dummy
scoreboard players set #nextid playerid 0
scoreboard players set @a playerid -1

#speedruns
scoreboard objectives add speedrun_timer dummy
scoreboard objectives add single_run_timer trigger
scoreboard objectives add new_world_timer trigger
scoreboard objectives modify speedrun_timer displayname {"translate":"roguecraft.speedrun.timer","color":"green"}
scoreboard objectives add single_run_timer trigger
scoreboard objectives add new_world_timer trigger

execute unless data storage roguecraft:master infinite_garden_skillpoint_phase run data merge storage roguecraft:master {infinite_garden_skillpoint_phase:0}
execute unless data storage roguecraft:master speedrun run data merge storage roguecraft:master {speedrun:{single_run_display:0b,new_world_display:0b}}
