...
$execute unless score @s $(upgrade) = @n[distance=..1,type=minecraft:marker] level_min run function roguecraft:shops/progressive/selling with entity @n[type=minecraft:marker] data