scoreboard players set @s lava_timer 200
tag @a[scores={lava_timer=1..}] add apply_lava_bar
execute at @s as @e[tag=id,type=marker] run function roguecraft:ability/lava_walker/apply_bossbar with entity @s data
