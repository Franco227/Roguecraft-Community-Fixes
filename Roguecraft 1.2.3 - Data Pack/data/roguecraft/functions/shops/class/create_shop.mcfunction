...
$execute positioned ~ ~2.75 ~ unless entity @e[type=item_display,tag=lock,distance=..1.5] run summon item_display ~ ~ ~ {item:{id:"totem_of_undying",Count:1b,tag:{CustomModelData:403}},Rotation:[$(rotation).0f,0.0f],Tags:["lock"]}
tp @s ~ ~0.5 ~
