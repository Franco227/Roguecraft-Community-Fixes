#init
execute if entity @e[type=minecraft:ender_dragon] unless entity @e[type=marker,tag=emaster] run schedule function custom_ender_dragon:init 1s append
...
execute if entity @e[type=minecraft:marker,tag=emaster,scores={dragon_phase=0,dragon_health=..100}] run scoreboard players set @e[type=marker,tag=emaster] dragon_phase 1


#dragon_phase 1/2
execute if score @e[type=marker,tag=emaster,limit=1] dragon_phase matches 1..2 run data merge entity @e[type=minecraft:ender_dragon,limit=1] {DragonPhase:5}
execute if score @e[type=marker,tag=emaster,limit=1] dragon_phase matches 1..2 run kill @e[type=dragon_fireball]
...
execute if entity @e[type=minecraft:marker,tag=emaster,scores={dragon_phase=3,dragon_health=..560}] run scoreboard players set @e[type=marker,tag=emaster] dragon_phase 4


#dragon_phase 4
execute if score @e[type=marker,tag=emaster,limit=1] dragon_phase matches 4 run data merge entity @e[type=minecraft:ender_dragon,limit=1] {DragonPhase:5}
...
execute if entity @e[type=minecraft:marker,tag=emaster,scores={dragon_phase=5,dragon_health=..320}] run scoreboard players set @e[type=marker,tag=emaster] dragon_phase 6

#dragon_phase 6/7/8/9/10/11
execute if score @e[type=marker,tag=emaster,limit=1] dragon_phase matches 6..11 in the_end positioned 0 100 0 run kill @e[type=area_effect_cloud,distance=..300]
execute if score @e[type=marker,tag=emaster,limit=1] dragon_phase matches 6..11 run data merge entity @e[type=minecraft:ender_dragon,limit=1] {DragonPhase:5}
...
#meteor
execute at @e[type=minecraft:armor_stand,nbt={OnGround:1b},tag=Meteor] run summon creeper ~ ~ ~ {Fuse:0,Invulnerable:true,CustomName:' "Ender Dragon" ',ExplosionRadius:4}
...
execute at @e[type=minecraft:armor_stand,nbt={OnGround:1b},tag=split_2] run summon creeper ~ ~ ~ {Fuse:0,Invulnerable:true,CustomName:' "Ender Dragon" ',ExplosionRadius:2}
...
execute at @e[type=minecraft:armor_stand,nbt={OnGround:1b},tag=split_3] run summon creeper ~ ~ ~ {Fuse:0,Invulnerable:true,CustomName:' "Ender Dragon" ',ExplosionRadius:1}
